...
let tag = "⍖"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '778967189096366131') // verilcek rol id
...
.setTitle(`Kayıt İşlemi Tamamlandı`)
    ...
    .addField(` <a:siyahtik:781231856845717504> Verilen Rol:`, `<@&${kayıtlı.id}> Rolleri Verildi <a:siyahtik:781231856845717504> `) 
